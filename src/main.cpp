...
#                        Version 1.0                                         #
#                                                                            #
#    Copyright 2013-2016 xxx  <xxx@gmail.com>                                #
#                                                                            #
##############################################################################
  ...
  To use this software, YOU MUST CITE the following publication:
     ...
     A Simple Framework for Extracting Accurate Depth Map from Lenslet-based Light-Field Cameras ECCV2016


**  Copyright (C) 2012-2015 xxx @ National University of xxx
